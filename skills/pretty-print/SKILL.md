---
name: pretty-print
description: Design or improve terminal and CLI output using semantic colors, stable status prefixes, readable grouping, and plain-text fallbacks. Use when building a command-line interface, reviewing console output, standardizing logs, or making terminal results easier to scan.
---
